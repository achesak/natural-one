...
class DiceRollerWindow(Gtk.ApplicationWindow):
    ...
    def __init__(self, style_css=None, *args, **kwargs):
        ...
        Gtk.StyleContext.add_class(template_edit_btn_box.get_style_context(), "linked")
        ...
        Gtk.StyleContext.add_class(template_file_btn_box.get_style_context(), "linked")
        self.template_action_bar.pack_start(template_file_btn_box)
        self.list_save_btn = Gtk.Button()
        save_img = Gtk.Image.new_from_gicon(Gio.ThemedIcon(name="document-save-symbolic"), Gtk.IconSize.BUTTON)
        ...
        open_img = Gtk.Image.new_from_gicon(Gio.ThemedIcon(name="document-open-symbolic"), Gtk.IconSize.BUTTON)
    ...
    def register_limit_inputs(self):
        ...
        for input in count_inputs:
            input.connect("changed", lambda i=input: self.limit_number_input(i, allow_negative=False))
